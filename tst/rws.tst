...
## Example 2.2.3
gap> r1 := OnePassKB( r0 );;
gap> PrintUsingLabels( r1, genfgmon, q8labs );
[ [ a^4, id ], [ b^4, id ], [ a*b*a*B, id ], [ a^2*b^2, id ], [ a*A, id ], [ 
...
gap> PrintUsingLabels( r2, genfgmon, q8labs );
...
gap> PrintUsingLabels( elmonq8, genfgmon, q8labs );
