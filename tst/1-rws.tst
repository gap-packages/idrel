...
gap> SetName( s3, "s3" );; 
gap> gseq3 := IdentityGroupRelatorSequences( s3 );; 
gap> Length( gseq3 ); 
9
gap> Y1 := gseq3[1];
[ 1, 6, [ [ s3_R1^-1, <identity ...> ], [ s3_R1, f1^-1 ] ] ]
gap> Y2 := gseq3[2];
[ 2, 4, [ [ s3_R2^-1, <identity ...> ], [ s3_R2, f2 ] ] ]
gap> Y3 := gseq3[3];
[ 3, 5, [ [ s3_R3^-1, <identity ...> ], [ s3_R3, f1*f2 ] ] ]
gap> Y9 := gseq3[9];
[ 9, 2, [ [ s3_R3^-1, <identity ...> ], [ s3_R1, f1 ], [ s3_R3^-1, f1^2 ], 
